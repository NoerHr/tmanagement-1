# TeamPulse — Design Handoff

This folder contains everything needed to implement TeamPulse.
...
- `instructions/incremental/` — 6 milestone instructions (foundation, then 5 sections)
...
- **Primary Color**: Indigo — buttons, links, active states
- **Secondary Color**: Amber — warnings, attention items
...
| 4 | Task Board | Task management with sub-task checklists and approval workflow |
| 5 | Notifications | In-app notifications, WhatsApp reminders, Google Calendar sync |
| 6 | Settings | User profiles, user management, brands, categories |
