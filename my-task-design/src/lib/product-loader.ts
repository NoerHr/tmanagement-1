...
// Debug: log detected product files
console.log('[ProductLoader] Detected files:', Object.keys(productFiles))
...
export function loadProductData(): ProductData {
  ...
  // Debug logging
  console.log('[ProductLoader] Loading product data...')
  console.log('[ProductLoader] Overview exists:', !!overviewContent)
  console.log('[ProductLoader] Roadmap exists:', !!roadmapContent)

  const parsedOverview = overviewContent ? parseProductOverview(overviewContent) : null
  const parsedRoadmap = roadmapContent ? parseProductRoadmap(roadmapContent) : null

  console.log('[ProductLoader] Parsed overview:', parsedOverview)
  console.log('[ProductLoader] Parsed roadmap:', parsedRoadmap)
